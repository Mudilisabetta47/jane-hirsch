...
const ScheduleSection = () => {
  const day1Schedule = [
    { time: "9:30 - 10:00 Uhr", title: "Ankommen & Begrüßung", icon: Coffee },
    { time: "10:00 - 13:30 Uhr", title: "Modernes Brautmakeup & Brautfrisur", icon: Camera },
    { time: "13:30 - 14:00 Uhr", title: "Pause", icon: Coffee },
    { time: "14:00 - 17:00 Uhr", title: "Weitere trendige Brautfrisuren", icon: Camera },
    { time: "17:00 - 17:30 Uhr", title: "Q&A, Verabschiedung & Zertifikatvergabe", description: "Für diejenigen die nur den Demo Tag buchen", icon: Award },
  ];

  const day2Schedule = [
    { time: "10:00 - 10:30 Uhr", title: "Lookbesprechung mit Model & Coach", icon: Coffee },
    { 
    ...
    { time: "15:30 - 16:30 Uhr", title: "Professionelle Fotos", icon: Camera },
    { time: "16:30 - 17:00 Uhr", title: "Zertifikatvergabe & Verabschiedung", icon: Award },
  ];
