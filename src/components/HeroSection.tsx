...
const HeroSection = ({ onScrollToRegistration }: HeroSectionProps) => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-cream">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Lerne professionelle Brautfrisuren und Makeup-Techniken von erfahrenen Experten. 
              Erweitere dein Portfolio mit atemberaubenden Braut-Looks.
            </motion.p>
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-elegant">
              <img
                src={heroImage}
                alt="Masterclass - Professionelle Brautfrisuren und Makeup"
